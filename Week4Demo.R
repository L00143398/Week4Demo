...
# check the date field of manager

managers$Date
# Needs reformatting currently in US format
...
restructured_date <- format(converted_date, format = "%d/%m/%Y")
restructured_date

restructured_date <- as.Date(converted_date, format = "%d/%m/%Y")
restructured_date
class(restructured_date)

# Assing newly structured date to the managers date filed

managers$Date <- restructured_date
